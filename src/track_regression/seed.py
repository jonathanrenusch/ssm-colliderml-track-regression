...
an identical torch twin for in-model use (:mod:`track_regression.seed_torch`).
...
DEFAULT_BZ = 3.0                # tesla: the field the ColliderML samples were simulated with (measured
                                # from 3-pixel-point circles vs truth pT); only seed q/p depends on it
...
# ---------------------------------------------------------------------------
# per-hit residuals to the seed helix
# ---------------------------------------------------------------------------
