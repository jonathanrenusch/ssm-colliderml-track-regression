...
point does not launch at B = 131k (grid limit).  Here one program owns one track: it
...
strict IEEE fp32 dots for fp32 inputs; fp16/bf16 inputs use the tensor cores
with fp32 accumulation and fp32 softmax.
"""
...
# runs at a fraction of HBM bandwidth.  One program per block of rows,
